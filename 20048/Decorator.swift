...
protocol DecoratorProtocol: class{

    func tileColor(value: Int) -> UIColor
    func numColor(value: Int) -> UIColor
    func fontForNum() -> UIFont
}
...
class Decorator : DecoratorProtocol {
    ...
    func tileColor(value: Int) -> UIColor {
        ...
        case 8:
            return UIColor(red: 224.0/255.0, green: 177.0/255.0, blue: 121.0/255.0, alpha: 1.0)
        case 16:
